const admin_team = [
  {
    ...
    description: `Étant le rapporteur de ce club me permet de transmettre les messages, les consigne et
        ...
        La créativité n'a pas de limite donc il y a trois réactions possibles à tout design:"Oui, Non et Waouh! La troisième 
        celle que je vise."`,
    role: "Rapporteur",
  },
  {
    name: "RAHAJANIRINA",
    firstname: "Fanomezantsoa Tokiniaina",
    image: "./assets/images/teams/Toki.jpg",
    description: `En tant que président du club multimédia, je suis
        convaincu que chaque membre de notre club possède un
        potentiel à explorer et un désir intense d'évoluer; une
        graine qui promet un arbre fruitier. Notre club est bien
        plus qu'une regroupement d'activités. C'est une source
        d'inspiration, un laboratoire où les idées prennent forme
        et où les rêves se réalisent.`,
    role: "Président",
  },
  {
    name: "RAZAFIARIVELO",
    firstname: "Miriame Asmine",
    image: "./assets/images/teams/Asmine.jpg",
    description: `Être designer est une source de fierté pour moi,car c'est à travers le design que je parviens 
        ...
        révèlent mes préférences ,mais surtout. Le design ets une réflexion de la vie elle-même.
        En tant que designer nous contribuons à batir de vie meilleur et du monde magique.`,
    role: "conseillée",
  },
  {
    name: "LARIO",
...
const all_teams = [
  {
    name: "DJAONASY",
    firstname: "Pierrot",
    image: "./assets/images/teams/Pierrot.jpg",
    description: `La créativité nourrit le design, lui donnant vie et le rendant unique. Ensemble, ils transforment l'imagination en réalité.`,
    role: "Designer"
  },
  {
    name: "SANDRINO",
    firstname: "Ickham Jonathan",
    image: "./assets/images/teams/Jonathan.jpg",
    description: `En tant que chef du groupe de contenu, on a effectué diverses tâches pour créer le site web vitrine de notre club multimédia en remplisant les éléments visuels et les contenus. Enfin, on a collaboré avec l'équipe pour tester le site.`,
    role: "Redacteur Web"
  },
  {
  ...
  {
    name: "TSITOHAINA",
    firstname: "Miharizo Danie",
    image: "./assets/images/teams/Tsito.jpg",
    description: `"En tant que rédacteur web du club, je suis poussé par la passion de transformer les idées en mots qui inspirent et éduquent. Chaque article que j'écris est une opportunité d'engager, d'informer et de connecter les membres de notre club, alimentant ainsi ma motivation. Je crois que chaque mot a le pouvoir de faire une différence, et c'est cette conviction qui me motive à donner le meilleur de moi-même à chaque fois que je m'assois pour écrire."`,
    role: "Redacteur Web"
  },
  {
    name: "KOTONIRINA",
    firstname: "Nidot",
    image: "./assets/images/teams/Nidot.jpg",
    description: `En tant que développeur web, chaque ligne de code est une chance de créer quelque chose de magique sur l'écran de quelqu'un car coder ne se délimite pas au dela d'une balise `,
    role: "Développeur"
  },
  {
    name: "FENITRINIANA",
    firstname: "Sylvie",
    image: "./assets/images/teams/Fenitra.jpg",
    description: `"En tant que designer web du club, je suis motivé par la possibilité de créer des expériences visuelles qui captivent et engagent. Chaque pixel que je place, chaque couleur que je choisis, est une expression de ma passion pour le design qui améliore la vie des membres de notre club.`,
    role: "Designer"
  },
  {
    name: "RAZANAKOTO",
    firstname: "Fenohasina Nantenaina",
    image: "./assets/images/teams/Nantenaina.jpg",
    description: `Même dans les plus bas situation qu'on puisse ne voir que le desespoir, il y a toujours un lueur d'espoir.  il faut s'adapter dans le present, le conserver pour pouvoir les resavourer à l'avenir. C'est ce qui me pousse à avancer dans la voie actuelle en aillant nul regret de tous ce que j'ai vécu.`,
    role: "Développeur"
  },
  {
    name: "RAVELOJAONA",
    firstname: "Andriatiana Christian",
    image: "./assets/images/teams/Christian.jpg",
    description: `La programmation est une forme d'art, où chaque ligne de code est une note de musique dans une symphonie numérique. En tant que développeur web, je suis un compositeur de solutions, un chef d'orchestre du code. Chaque projet est une partition à interpréter, une opportunité de créer quelque chose de beau et de fonctionnel.`,
    role: "Développeur"
  },
  {
    name: "Andriantsoa",
